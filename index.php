<!DOCTYPE html>
	<head>
	<meta charset="utf-8">
	<title>Dummy &mdash; Music Streaming</title>
	...
	<div id="xce-page">
	  ...
	  <aside id="xce-aside" role="complementary" class="border js-fullheight">
		...
		<div id="xce-main">
			<aside id="xce-hero" class="js-fullheight">
			...
			<div class="xce-narrow-content">
				<h2 class="xce-heading animate-box" data-animate-effect="fadeInLeft">Services</h2>
				<div class="row">
					<div class="col-md-6">
						<div class="xce-feature animate-box" data-animate-effect="fadeInLeft">
							<div class="xce-icon">
			...
			<div class="xce-narrow-content">
				<h2 class="xce-heading animate-box" data-animate-effect="fadeInLeft">Recent Blog</h2>
	...
	<script type="text/javascript">
		setTimeout(function() {
			...
			$('.js-xce-nav-toggle').addClass('active');
		}, 1500);
